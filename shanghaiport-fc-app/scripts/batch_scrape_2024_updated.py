...
def scrape_match(url: str, match_info: dict) -> dict:
  ...
  // Shots on Target - FBref格式：
  // 主队：7 of 16 — 44%  客队：23% — 3 of 13
...
def main():
    print("="*70)
    print("上海海港2024赛季完整数据批量抓取器")
    print("="*70)
    print()
    
    # 读取比赛URL列表（2024格式是直接的数组）
