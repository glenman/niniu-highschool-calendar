#!/usr/bin python3
"""
按照模板格式完整抓取所有29轮比赛数据 - 修复版
使用临时文件存储JavaScript返回的数据
"""
...
def scrape_match_complete(url: str, match_info: dict) -> dict:
    ...
    try:
        ...
        (() => {
          ...
          // 保存到文件
          const fs = require('fs');
          fs.writeFileSync('{tmp_path}', JSON.stringify(result, null, 2));
          return 'done';
        })()
        """
