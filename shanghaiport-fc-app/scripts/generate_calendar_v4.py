#!/usr/bin/env python3
"""
生成上海海港2026赛季赛程ICS文件（真实数据 + 准确球场信息）
"""
...
def generate_ics(schedule_data, filename="data/2026-calendar.ics"):
    ...
    for match in schedule_data['matches']:
        ...
        if match['venue'] == 'Home':
            ...
            # 客场：对手 vs 上海海港
            summary = f"{match['opponent_cn']} vs 上海海港（{venue_text}）"
    ...
    # 显示标题格式示例
    print("\n✅ 日历标题格式:")
    print("  主场比赛: 上海海港 vs 河南队（主场）")
    print("  客场比赛: 大连英博 vs 上海海港（客场）")
    print("  德比大战: 上海申花 vs 上海海港（客场）⚔️")

    return filename

if __name__ == "__main__":
    print("正在生成上海海港2026赛季日历（主客场标题已调整）...")
