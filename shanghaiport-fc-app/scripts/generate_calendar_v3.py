...
def generate_ics(schedule_data, filename="data/2026-calendar.ics"):
    ...
    corrections = {
        "上海申花": "八万人体育场（原：虹口足球场）",
        "重庆铜梁龙": "龙兴足球场（原：铜梁龙体育场）",
        "沈阳城建": "沈阳铁西足球场（原：奥林匹克体育中心）",
        "大连英博": "大连梭鱼湾足球场（原：体育中心体育场）",
        "天津津门虎": "天津奥体中心体育场（原：泰达足球场）"
    }
    for team, stadium in corrections.items():
        print(f"  • {team}: {stadium}")

    return filename

if __name__ == "__main__":
    print("正在生成上海海港2026赛季日历（球场信息已更正）...")
